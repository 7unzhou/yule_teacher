...
import com.yulebaby.teacher.BuildConfig;
...
public class ImageCache {
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
    	...
    	Log.d(TAG, "getExternalCacheDir(context).getPath() " + getExternalCacheDir(context));
    	Log.d(TAG, "context.getCacheDir().getPath() " + context.getCacheDir().getPath());
