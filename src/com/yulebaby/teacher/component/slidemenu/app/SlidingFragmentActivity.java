...
public class SlidingFragmentActivity extends FragmentActivity implements SlidingActivityBase {
	...
	public void setBehindLeftContentView(View v) {
		setBehindLeftContentView(v, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
	}
	...
	public void setBehindRightContentView(View v) {
		setBehindRightContentView(v, new LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
	}
